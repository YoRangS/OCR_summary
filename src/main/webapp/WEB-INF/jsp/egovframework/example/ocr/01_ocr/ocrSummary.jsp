                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input class="txt" type="text" id="fileName" name="fileName" value=${fileName}>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>사용할 언어</th>
                                            <td>
                                                <input class="txt" type="text" id="lang" name="lang" value=${lang}>
                                            </td>
                                        </tr>
                                        <tr>
                                        	<th>요약할 내용</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex_group">
                                                    <div class="input_group">
                                                        <input type="text" class="form_control" name="">
                                                    </div>
                                                    <!-- [D] 버튼 비활성화 시 disabled 속성 추가 필요
                                                    기본 : <button class="btn">
                                                    비활성화 : <button class="btn" disabled> -->
...
>>>>>>> 2d15c6d22d6a9906ca480cbf2995dd76eff32c24
</html>