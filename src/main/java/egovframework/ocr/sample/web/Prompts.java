...
public class Prompts {
    ...
    private static String TAG_ENG = "The following is the text we want to get the tags for."
    		...
    		+ " Punctuation marks except\"\" should not be considered as a keyword";
    ...
    private static String TAG_KOR = "다음 문장은 주요 태그를 추출하려고 하는 텍스트 전문입니다."
    		+ " 아래 텍스트에서 중요한 키워드와 빈도수를 같이 추출한 뒤 다른 설명 없이 {단어: 3} 와 같이 json 형식으로만 보여주세요. \"\" 를 제외한 문장 부호는 태그로 추가하면 안됩니다.";
